                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            You can view your dailly schedule, Reach Students Appointment at PCU!<br><br>
                            </p>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/calendar.png');"></div>
                                                    </div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/calendar.png');">
                                                            </div>
                                                    </div>
                                                </td>
                                                </tr>
